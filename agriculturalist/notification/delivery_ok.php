...
?>
        ...
        <div class="notification-row">
          ...
          <div class="notification-buttons">
            ...
            <button onclick="window.location.href='reject_add.php?orderId=<?php echo $accept; ?>'" type="submit" value="0" name="status" class="notification-button reject">Cancel</button>
          </div>
        </div>
