<?php 
    ...
    try{
        ...
        $sql1 = "SELECT COUNT(user_id) AS count, role FROM leafy.user GROUP BY role ORDER BY COUNT(user_id)";
        $result1 = $pdo->query($sql1);
        $usercount = $result1->fetchAll(PDO::FETCH_ASSOC);
        $count = [];
        $role = [];
  ...
  <body>
    ...
    <div class="chartCard">
      <div class="chartBox">
        ...
        <input oninput="updateChart(this)" type="range" id="points" value="5" min="2" max="5">
      </div>
      <div class="chartBox">
