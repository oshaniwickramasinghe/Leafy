...
if (isset($_POST['submit'])) {
	...
	//   $_POST['cpassword'] = "";
      //header("Location: login.php");
	   ...
	   <a href = "http://localhost/interim/interim-Govindani/verify.php?code='.urldecode($verification_code) .'">http://localhost/interim/interim-Govindani/verify.php?code = '.$verification_code .'</a></b>';
	   $mail->send();
