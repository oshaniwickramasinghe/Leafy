    ...
    <div class="main-container">
        <div class="left_menu_bar">
            ...
            <ul>
                ...
                <li><a href="blog.php"><i class="fa-brands fa-blogger" style="font-size:20px;color:#43562B;"></i>My Blogs</a></li>
                <li><a href=""><i class="fa-brands fa-readme" style="font-size:18px;color:#43562B;"></i>My Courses</a></li>
            </ul>
        </div>
