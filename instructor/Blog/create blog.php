<?php
 ...
 if(isset($_POST['submit']))
 {
   /* $blog_ID=mysqli_real_escape_string($conn,$_POST['blog_ID']); */
    ...
    $sql1=" INSERT INTO blog(title,content1,content2,content3,content4,image1,image2,image3,image4,user_id) Values ('$title','$content1','$content2','$content3','$content4','$image1','$image2','$image3','$image4','$user_ID')";
 ...
 if(isset($_POST['update'])){
    ...
    content1='$content1', content2='$content2', content3='$content3', content4='$content4', image1='$newimage1', image2='$newimage2', image3='$newimage3', image4='$newimage4' WHERE blog_id='$blog_ID'");
        ...
        <form action="" method="post" enctype="multipart/form-data">
          ...
          <div class="field">
            ...
            <div class="content">
                ...
                <div>
                <label for="content1">First Paragraph</label><br>
                <textarea for="content1" id="content1" name="content1" class="text_input"  value="" required><?= $content1; ?></textarea><br>
                </div>
                <div>
                <label for="content2">second Paragraph</label><br>
                <textarea for="content2" id="content2" name="content2" class="text_input"  value="" required><?= $content2; ?></textarea><br>
                </div>
                <div>
                <label for="content3">Third Paragraph</label><br>
                <textarea for="content3" id="content3" name="content3" class="text_input"  value="" required><?= $content3; ?></textarea><br>
                </div>
                <div>
                <label for="content4">Last Paragraph</label><br>
                <textarea for="content4" id="content4" name="content4" class="text_input"  value="" required><?= $content4; ?></textarea><br>
                </div>
            </div>
            <div class="images">
            <label for="image">Attach images</label><br><br>
            <div>
                <label for="image1"> Image for first paragraph</label>
            ...
            <div> 
                <label for="image2">Image for second paragraph</label>
                <input type="hidden" name="oldimage2" value="<?= $image2; ?>">
                <input type="file" name="image2" class="text_input" accept="image/jpg, image/jpeg, image/png"><br>

                <?php if($update == true) {?>
                <div>
                    <img src="../images/<?= $image2; ?>" width ="120" class="img-thumbnail">
                </div>
                <?php } else {?>
                <div>
                    <img src="../images/<?= $image2; ?>" width ="120" class="img-thumbnail" style="visibility:hidden" >
                </div>
                <?php } ?>
            </div> 
            <div>
                <label for="image3">Image for third paragraph</label>
                <input type="hidden" name="oldimage3" value="<?= $image3; ?>">
                <input type="file" name="image3" class="text_input" accept="image/jpg, image/jpeg, image/png"><br>

                <?php if($update == true) {?>
                <div>
                    <img src="../images/<?= $image3; ?>" width ="120" class="img-thumbnail">
                </div>
                <?php } else {?>
                <div>
                    <img src="../images/<?= $image3; ?>" width ="120" class="img-thumbnail" style="visibility:hidden" >
                </div>
            <?php } ?>
            </div>  
            <div>  
                <label for="image4">Image for last paragraph</label>
                <input type="hidden" name="oldimage4" value="<?= $image4; ?>">
                <input type="file" name="image4" class="text_input" accept="image/jpg, image/jpeg, image/png"><br>

                <?php if($update == true) {?>
                <div>
                    <img src="../images/<?= $image4; ?>" width ="120" class="img-thumbnail">
                </div>
                <?php } else {?>
                <div>
                    <img src="../images/<?= $image4; ?>" width ="120" class="img-thumbnail" style="visibility:hidden" >
                </div>
            <?php } ?>
            </div> 
            </div>
