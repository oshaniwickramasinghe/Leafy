            ...
            <div class="content">
                <div class="first_para">
                    ...
                    <div class="content-img">
                        ...
                        <div class="image"> 
                            <img src="../images/<?php if(isset ($image1)){ echo $image1;} ?>">
                        </div>
                    </div>
                </div>
                <diV class="second_para">
                    ...
                    <div class="content-img">
                        <div class="image">
                            <img src="../images/<?php if(isset ($image2)){ echo $image2;} ?>">
                        </div>
                        <div class="text"> 
                ...
                <diV class="third_para">
                    ...
                    <div class="content-img">
                        <div class="text"> 
                            <p><?php if(isset ($content3)){ echo $content3;} ?></p>
                        </div>
                        <div class="image">
                            <img src="../images/<?php if(isset ($image3)){ echo $image3;} ?>">
                        </div>    
                    </div>
                </diV>
                <diV class="last_para">
                    ...
                    <div class="content-img">
                        <div class="image">
                            <img src="../images/<?php if(isset ($image4)){ echo $image4;} ?>">
                        </div> 
                        <div class="text"> 
                            <p><?php if(isset ($content4)){ echo $content4;} ?></p>
                        </div>
                    </div>
                </diV>
            </div>
