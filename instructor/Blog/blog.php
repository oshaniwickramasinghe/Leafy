            ...
            while($record2 = mysqli_fetch_assoc($result3))
             {
               ...
               // $author=$record2['author'];
                ...
                $content2=$record2['content2'];
                $content3=$record2['content3'];
                $content4=$record2['content4'];
               // $comment=$record2['comment'];
                $time=$record2['time'];
                $image1=$record2['image1'];
                $image2=$record2['image2'];
                $image3=$record2['image3'];
                $image4=$record2['image4'];
                ...
                <div class="details_container">
                    ...
                    <table>
                        ...
                        <tr>
                            <th>Image2</th>
                            <td>:</td>
                            <td><img src="../images/<?php if(isset ($image2)){ echo $image2;} ?>" align="middle" width="110"></td>
                        </tr>
                        <tr>
                            <th>Image3</th>
                            <td>:</td>
                            <td><img src="../images/<?php if(isset ($image3)){ echo $image3;} ?>" align="middle" width="110"></td>
                        </tr>
                        <tr>
                            <th>Image4</th>
                            <td>:</td>
                            <td><img src="../images/<?php if(isset ($image4)){ echo $image4;} ?>" align="middle" width="110"></td>
                        </tr>
                        <tr>
                            <th>Title </th>
                            <td>:</td>
                        ...
                        <tr>
                            <th>Content2</th>
                            <td>:</td>
                            <td><?php if(isset ($content2)){ echo $content2;} ?></td>
                        </tr>
                        <tr>
                            <th>Content3</th>
                            <td>:</td>
                            <td><?php if(isset ($content3)){ echo $content3;} ?></td>
                        </tr>
                        <tr>
                            <th>Content4</th>
                            <td>:</td>
                            <td><?php if(isset ($content4)){ echo $content4;} ?></td>
                        </tr>
                       <!-- <tr>
                            <th>Comment </th>
                            <td>:</td>
